...
public class Success_DialogFragment extends BaseDialogFragment implements View.OnClickListener {
...
//                view.findViewById(R.id.group_middle).setVisibility(View.VISIBLE);
    ...
    public static class Builder {
        ...
        public Success_DialogFragment build() {
            Success_DialogFragment fragment = getFragment();
        ...
        protected Success_DialogFragment getFragment() {
            return new Success_DialogFragment();
        }

        public Success_DialogFragment show() {
            Success_DialogFragment fragment = build();
