...
public class MyHornRowText extends EaseChatRow {
    private TextView contentView;
    private EaseImageView iv_userhead;
    private ConstraintLayout cons_Mes;

    public MyHornRowText(Context context, boolean isSender) {
        super(context, isSender);
    }

    public MyHornRowText(Context context, EMMessage message, int position, Object adapter) {
        super(context, message, position, adapter);
    }

    @Override
    protected void onInflateView() {
        inflater.inflate(!showSenderType ? R.layout.ease_row_received_horn
                : R.layout.ease_row_sent_horn, this);
    }
