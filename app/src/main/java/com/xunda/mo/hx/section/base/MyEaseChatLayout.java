...
public class MyEaseChatLayout extends RelativeLayout implements IChatLayout, IHandleMessageView, IPopupWindow
    ...
    private static final String TAG = MyEaseChatLayout.class.getSimpleName();
    ...
    public MyEaseChatLayout(Context context) {
        this(context, null);
    }

    public MyEaseChatLayout(Context context, AttributeSet attrs) {
