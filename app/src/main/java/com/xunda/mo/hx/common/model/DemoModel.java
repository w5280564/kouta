...
import com.xunda.mo.hx.common.manager.OptionsHelper;
...
public class DemoModel {
    ...
    public DemoDbHelper getDbHelper() {
        return DemoDbHelper.getInstance(MyApplication.getInstance());
    }
...
//        }
    ...
    public boolean isFirstInstall() {
        SharedPreferences preferences = MyApplication.getInstance().getSharedPreferences("first_install", Context.MODE_PRIVATE);
