...
import com.xunda.mo.hx.common.manager.UserProfileManager;
import com.xunda.mo.hx.common.model.DemoModel;
import com.xunda.mo.hx.common.model.EmojiconExampleGroupData;
import com.xunda.mo.hx.common.receiver.HeadsetReceiver;
import com.xunda.mo.hx.common.utils.FetchUserInfoList;
...
import com.xunda.mo.hx.section.chat.delegates.MyEaseImageAdapterDelegate;
import com.xunda.mo.hx.section.chat.delegates.MyEaseLocationAdapterDelegate;
...
//                .enableFCM("921300338324")
    ...
    public DemoModel getModel(){
        if(demoModel == null) {
            demoModel = new DemoModel(MyApplication.getInstance());
        }
        return demoModel;
    }
...
//        }
    ...
    public synchronized int deleteContact(String username) {
        ...
        DemoDbHelper helper = DemoDbHelper.getInstance(MyApplication.getInstance());
