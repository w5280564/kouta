...
import com.xunda.mo.hx.section.chat.activicy.MyEaseShowBigImageActivity;

public class MyEaseImageViewHolder extends EaseChatRowViewHolder {

    public MyEaseImageViewHolder(@NonNull View itemView, MessageListItemClickListener itemClickListener) {
    ...
    public static EaseChatRowViewHolder create(ViewGroup parent,
        ...
        return new MyEaseImageViewHolder(new EaseChatRowImage(parent.getContext(), isSender), itemClickListener);
    }
    ...
    public void onBubbleClick(EMMessage message) {
        ...
        Intent intent = new Intent(getContext(), MyEaseShowBigImageActivity.class);
