...
public class MyEaseHandleMessagePresenterImpl extends EaseHandleMessagePresenter {
    private static final String TAG = MyEaseHandleMessagePresenterImpl.class.getSimpleName();
