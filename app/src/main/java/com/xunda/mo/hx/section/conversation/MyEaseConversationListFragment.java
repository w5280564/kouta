...
public class MyEaseConversationListFragment extends EaseBaseFragment implements OnItemClickListener, OnPopupMenuItemClickListener, OnPopupMenuPreShowListener, SwipeRefreshLayout.OnRefreshListener, OnConversationLoadListener, OnConversationChangeListener {
    private static final String TAG = MyEaseConversationListFragment.class.getSimpleName();
    public LinearLayout llRoot;
    public MyEaseConversationListLayout conversationListLayout;
    ...
    /**
     * 会话长按菜单显示前的监听事件，可以对PopupMenu增加条目{@link MyEaseConversationListLayout#addItemMenu(int, int, int, String)}，
     * 隐藏或者显示条目{@link MyEaseConversationListLayout#findItemVisible(int, boolean)}
     * @param menuHelper
     * @param position
     */
    @Override
