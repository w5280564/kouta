...
import com.xunda.mo.BuildConfig;
import com.xunda.mo.R;
import com.xunda.mo.hx.section.base.BaseFragment;
import com.xunda.mo.hx.common.interfaceOrImplement.OnResourceParseCallback;
import com.xunda.mo.hx.common.utils.video.ImageCache;
import com.xunda.mo.hx.common.utils.video.ImageResizer;
import com.xunda.mo.hx.common.utils.video.Utils;
import com.xunda.mo.hx.common.widget.DividerGridItemDecoration;
import com.xunda.mo.hx.common.widget.RecyclingImageView;
import com.xunda.mo.hx.section.chat.viewmodel.VideoListViewModel;
...
public class ImageGridFragment extends BaseFragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageResizer = new ImageResizer(requireActivity(), mImageThumbSize);
		mImageResizer.setLoadingImage(R.drawable.em_empty_photo);
		mImageResizer.addImageCache(requireActivity().getSupportFragmentManager(),
				cacheParams);
	}
