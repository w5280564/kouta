...
import com.xunda.mo.hx.section.chat.views.ChatRowAddMes;
import com.xunda.mo.main.constant.MyConstant;

public class MyGroupAddMesAdapterDelegate extends EaseMessageAdapterDelegate<EMMessage, EaseChatRowViewHolder> {
    @Override
...
//        return item.getType() == TXT && !item.getStringAttribute(MyConstant.MESSAGE_TYPE_CREATE_GROUP, "").isEmpty();
        if (item.getType() == EMMessage.Type.TXT) {
            ...
            return TextUtils.equals(Group, MyConstant.MESSAGE_TYPE_CREATE_GROUP) ? true : false;
        }
        return false;
    }
    ...
    protected EaseChatRow getEaseChatRow(ViewGroup parent, boolean isSender) {
        return new ChatRowAddMes(parent.getContext(), isSender);
    }
