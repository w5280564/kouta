...
public class MyEaseChatRowVideo extends EaseChatRowFile {
    private static final String TAG = MyEaseChatRowVideo.class.getSimpleName();
    ...
    public MyEaseChatRowVideo(Context context, boolean isSender) {
        super(context, isSender);
    }

    public MyEaseChatRowVideo(Context context, EMMessage message, int position, Object adapter) {
