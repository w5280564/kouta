...
public class CaptchaInputView extends EditText {
    ...
    public CaptchaInputView(Context context, AttributeSet attrs) {
        ...
        final int defaultBorderColor = res.getColor(R.color.greytwo);
        ...
        final int defaultPasswordColor = res.getColor(R.color.blacktitle);
        ...
        mBorderRadius  = res.getDimension(R.dimen.mBorderRadius);
...
//        int screenHeight = display.getHeight();
        ...
        linePaint.setColor(getResources().getColor(R.color.blacktitle));
...
//	}
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < passwordLength; i++) {
            if (i < mSelectIndex) {
                //彩色边框
                borderPaint.setColor(getResources().getColor(R.color.yellowtwo));
            } else {
                //灰色边框
                borderPaint.setColor(borderColor);
            }
//            if (i == mSelectIndex){ //选中状态
//
//            }
            RectF rectF = new RectF(left, top, mDefaultInputViewTextSize + left, mDefaultInputViewTextSize + top);
            rectList.add(rectF);
            canvas.drawRoundRect(rectF, mBorderRadius, mBorderRadius, borderPaint);
