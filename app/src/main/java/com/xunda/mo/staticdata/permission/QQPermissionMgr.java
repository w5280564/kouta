...
public class QQPermissionMgr {
    private static final QQPermissionMgr sInstance = new QQPermissionMgr();
    ...
    private QQPermissionMgr() {}

    public static QQPermissionMgr getInstance() {
        return sInstance;
    }
