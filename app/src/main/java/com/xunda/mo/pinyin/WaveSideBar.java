...
public class WaveSideBar extends View {
    ...
    public void setStringList(List<String> nameList) {
        mLetters = nameList;
        invalidate();
    }
...
//                float selectline = ((target.bottom + target.top - Metrics.bottom - Metrics.top) - mLetters.size() * mItemHeight) / 2 + mItemHeight * i;
//               float y = baseline / 2 + mItemHeight * mLetters.get(mChoosePosition).hashCode();
