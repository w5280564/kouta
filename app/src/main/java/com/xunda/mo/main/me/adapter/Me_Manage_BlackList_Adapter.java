package com.xunda.mo.main.me.adapter;
 ...
 * Created by Admin on
 */
public class Me_Manage_BlackList_Adapter extends RecyclerView.Adapter<Me_Manage_BlackList_Adapter.MyViewHolder> {
    List<GroupBlackList_Bean.DataDTO> otherList;
    Context context;
    private int myposition;

    public Me_Manage_BlackList_Adapter(Context context, List<GroupBlackList_Bean.DataDTO> otherList) {
