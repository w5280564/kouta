 ...
 * 设置我在群中的昵称
 */
public class ChangeMyGroupNickNameActivity extends BaseInitActivity {
    ...
    public static void actionStart(Context context,String name,String myGroupId) {
        Intent intent = new Intent(context, ChangeMyGroupNickNameActivity.class);
    ...
    private void initTitle() {
        ...
        return_Btn.setOnClickListener(new ChangeMyGroupNickNameActivity.return_Btn());
        right_Btn.setOnClickListener(new ChangeMyGroupNickNameActivity.right_Btn());
    }
