...
public class GroupAddMember_Adapter extends EaseBaseRecyclerViewAdapter<MyEaseUser> {
    ...
    public GroupAddMember_Adapter() {
        this.isCreateGroup = false;
        selectedMembers = new ArrayList<>();
        MyEaseUserList = new ArrayList<>();
    }

    public GroupAddMember_Adapter(boolean isCreateGroup) {
...
//            avatar.setImageResource(R.drawable.img_pic_none);
    ...
    public int getSectionForPosition(int position) {
        return mData.get(position).getInitialLetter().charAt(0);
    }
    ...
    public int getPositionForSection(int section) {
        for (int i = 0; i < getItemCount(); i++) {
            String sortStr = mData.get(i).getInitialLetter();
