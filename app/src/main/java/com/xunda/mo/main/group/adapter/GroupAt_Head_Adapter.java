...
public class GroupAt_Head_Adapter extends EaseBaseRecyclerViewAdapter<MyEaseUser> {
    ...
    public GroupAt_Head_Adapter() {
        this.isCreateGroup = false;
        selectedMembers = new ArrayList<>();
        MyEaseUserList = new ArrayList<>();
    }

    public GroupAt_Head_Adapter(boolean isCreateGroup) {
