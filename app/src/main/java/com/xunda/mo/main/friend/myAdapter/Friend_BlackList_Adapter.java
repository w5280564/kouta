 ...
 * Created by Admin on
 */
public class Friend_BlackList_Adapter extends RecyclerView.Adapter<Friend_BlackList_Adapter.MyViewHolder> {
    List<GroupBlackList_Bean.DataDTO> otherList;
    Context context;
    private int myposition;

    public Friend_BlackList_Adapter(Context context, List<GroupBlackList_Bean.DataDTO> otherList) {
...
//        this.otherList = otherList;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder myview = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.friend_blacklist_adapter, null));
        return myview;
    }
...
//                        v.setEnabled(false);
        ...
        String moIDStr = String.format("Mo ID：%1$s", oneData.getUserNum());
