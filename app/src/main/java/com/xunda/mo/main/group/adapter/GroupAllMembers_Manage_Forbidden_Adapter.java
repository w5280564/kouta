 ...
 * Created by Admin on
 */
public class GroupAllMembers_Manage_Forbidden_Adapter extends RecyclerView.Adapter<GroupAllMembers_Manage_Forbidden_Adapter.MyViewHolder> {
    List<GroupForbiddenList_Bean.DataDTO> otherList;
    Context context;
    private int myposition;

    public GroupAllMembers_Manage_Forbidden_Adapter(Context context, List<GroupForbiddenList_Bean.DataDTO> otherList) {
        this.otherList = otherList;
        this.context = context;
    }

    public void addMoreData(List<GroupForbiddenList_Bean.DataDTO> otherList) {
//        this.otherList = otherList;
        notifyDataSetChanged();
    }

    public void setData(List<GroupForbiddenList_Bean.DataDTO> otherList) {
        this.otherList = otherList;
        notifyDataSetChanged();
    }
    ...
    public void onBindViewHolder(@NotNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        final GroupForbiddenList_Bean.DataDTO oneData = otherList.get(position);
       ...
       String timeStr =  StaticData.toDateMinute(oneData.getMuteEndTime());

        String moIDStr = String.format("Mo ID：%1$s · %2$s解除", oneData.getUserNum() ,timeStr);
