 ...
 * 两个按钮的弹出框(带标题)
 */
public class TwoButtonDialogWithTitle extends Dialog implements
	...
	public TwoButtonDialogWithTitle(Context context, String content, String left,
	...
	public TwoButtonDialogWithTitle(Context context, String title, String content, String left,
									String right, ConfirmListener confirmListener) {
		super(context, R.style.CenterDialogStyle);
		this.listener = confirmListener;
		this.title = title;
