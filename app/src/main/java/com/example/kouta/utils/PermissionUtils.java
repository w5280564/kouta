package com.example.kouta.utils;
...
/**
 * Created by waylen on 2017/12/21.
 */
...
//        }
        ...
        try {
            checkSelfPermission = checkSelfPermission(activity, requestPermission);
...
//            Log.i(TAG, "ActivityCompat.checkSelfPermission != PackageManager.PERMISSION_GRANTED");
            if (shouldShowRequestPermissionRationale(activity, requestPermission)) {
//                Log.i(TAG, "requestPermission shouldShowRequestPermissionRationale");
                shouldShowRationale(activity, requestCode, requestPermission);
            } else {
//                Log.d(TAG, "requestCameraPermission else");
                requestPermissions(activity, new String[]{requestPermission}, requestCode);
            }
        } else {
//            Log.d(TAG, "ActivityCompat.checkSelfPermission ==== PackageManager.PERMISSION_GRANTED");
//            Toast.makeText(activity, "opened:" + requestPermissions[requestCode], Toast.LENGTH_SHORT).show();//没打开权限的提醒
            ...
            showMessageOKCancel(activity, "should open those permission",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            requestPermissions(activity, shouldRationalePermissionsList.toArray(new String[shouldRationalePermissionsList.size()]),
                                    CODE_MULTI_PERMISSION);
//                            Log.d(TAG, "showMessageOKCancel requestPermissions");
                        }
                    });
