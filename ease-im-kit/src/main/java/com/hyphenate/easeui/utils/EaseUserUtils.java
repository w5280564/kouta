...
//        userProvider = EaseUI.getInstance().getUserProfileProvider();
        ...
        if(user != null && user.getAvatar() != null){
            try {
                ...
                Glide.with(context).load(user.getAvatar())
                        .apply(RequestOptions.placeholderOf(R.drawable.img_pic_none)
                                .diskCacheStrategy(DiskCacheStrategy.ALL))
                        .into(imageView);
            }
        }else{
            Glide.with(context).load(R.drawable.img_pic_none).into(imageView);
        }
    }
     ...
     * @param username
     */
    public static void setUserAvatarAndSendHeaderUrl(Context context, String username,String header_url_message, ImageView imageView){
        EaseUser user = getUserInfo(username);
        if(user != null && user.getAvatar() != null){
            Glide.with(context).load(user.getAvatar())
                    .apply(RequestOptions.placeholderOf(R.drawable.img_pic_none)
            ...
            Glide.with(context).load(header_url_message).placeholder(R.drawable.img_pic_none).error(R.drawable.img_pic_none).into(imageView);
        }
    }
