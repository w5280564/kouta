...
//        Log.d("onItemClick","onBindViewHolder>>>position>>>"+position);
//        Log.d("onItemClick","onBindViewHolder>>>mData.size>>>"+mData.size());
...
//                    Log.e("onItemClick","onItemClick>>>position>>>"+position);
                    if (position>=0) {
    ...
    public void addData(int position, List<T> data) {
        Log.d("data---->>>>", "addDataListposition");
        synchronized (EaseBaseRecyclerViewAdapter.class) {
            if(data == null || data.isEmpty()) {
                return;
            }
    ...
    public void addData(int position, List<T> data, boolean refresh) {
        Log.d("data---->>>>", "addDataListpositionrefresh");
        synchronized (EaseBaseRecyclerViewAdapter.class) {
            if(data == null || data.isEmpty()) {
                return;
            }
